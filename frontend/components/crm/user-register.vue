...
<template>
       ...
       <form @submit.prevent="handleRegister()">
           <div class="mt-6">
               ...
               <div class="mt-1 relative rounded-md shadow-sm">
                   <input id="name" 
                   v-model="userInfo.name" placeholder="Enter User name" type="text" 
                   class="email-input">
           ...
           <div class="mt-6">
               ...
               <div class="mt-1 relative rounded-md shadow-sm">
                   <input id="email" 
                   v-model="userInfo.email" placeholder="Enter your email" type="email" 
                   class="email-input">
                   <div class="hidden absolute inset-y-0 right-0 pr-3 
                   items-center pointer-events-none">
                       <svg class="h-5 w-5 text-red-500" fill="currentColor" viewBox="0 0 20 20">
           ...
           <div class="mt-6">
               <label for="password_confirmed" class="block text-sm font-medium leading-5
                 text-gray-700">Password Confirm</label>
               <div class="mt-1 rounded-md shadow-sm">
                   <input id="password_confirmed" 
   ...
   <style scoped>
   .btn-login {
     @apply w-full flex justify-center py-2 px-4 border border-transparent text-sm 
